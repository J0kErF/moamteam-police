# moamteam — POLICE agent

> **This repository is the POLICE agent** of moamteam's final
> project (rule #49: one repository per agent). The engine is symmetric
> and role-parameterized — run this side with:
>
> ```powershell
> uv sync
> uv run python -m moamteam peer --role police --gui
> ```
>
> Sibling repository (thief agent):
> <https://github.com/J0kErF/moamteam-thief>
